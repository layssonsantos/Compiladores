...
import br.ufscar.dc.compiladores.t3.AnalisadorSemanticoLAParser.Fator_logicoContext;
...
public class SemanticoUtils {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Exp_aritmeticaContext ctx) {
    ...
    // promovendo para REAL se houver incompatibilidade numérica.
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.TermoContext ctx) {
        // A variável que será retornada ao fim da execução é inicializada com o tipo
        // do primeiro elemento que será verificado, para fins de comparação.
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.FatorContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.ParcelaContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Parcela_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
        ...
        if (ctx.identificador() != null) {
            ...
            // exibido e, caso ainda não tenha sido, o adiciona à lista.
                ...
                TabelaDeSimbolos tabelaAux = Semantico.escoposAninhados.percorrerEscoposAninhados().get(Semantico.escoposAninhados.percorrerEscoposAninhados().size() - 1);
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Parcela_nao_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.ExpressaoContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Termo_logicoContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Fator_logicoContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Parcela_logicaContext ctx) {
        TipoT3 tipoRetorno;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, AnalisadorSemanticoLAParser.Exp_relacionalContext ctx) {
