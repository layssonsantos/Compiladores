...
import static br.ufscar.dc.compiladores.t5.SemanticoUtils.verificarTipo;
import br.ufscar.dc.compiladores.t5.TabelaDeSimbolos.TipoRegistro;
import br.ufscar.dc.compiladores.t5.TabelaDeSimbolos.TipoT5;

public class GeradorC extends AnalisadorSemanticoLABaseVisitor<Void> {
    ...
    public Void visitDeclaracao_local(AnalisadorSemanticoLAParser.Declaracao_localContext ctx) {
        ...
        // Verifica se é a criação de um registro.  
            ...
            escopoAtual.adicionar(ctx.IDENT().getText(), TipoT5.REGISTRO, TipoRegistro.VARIAVEL);
    ...
    @Override
    public Void visitVariavel(AnalisadorSemanticoLAParser.VariavelContext ctx) {
        ...
        if (ctx.tipo().tipo_estendido() != null) {
            ...
            for (AnalisadorSemanticoLAParser.IdentificadorContext ictx : ctx.identificador()) {
                nomeVar = ictx.getText();

                if (tipoEstendido)
                    escopoAtual.adicionar(nomeVar, TipoT5.REGISTRO, TipoRegistro.VARIAVEL);
                else
                    escopoAtual.adicionar(nomeVar, tipoAuxT5, TipoRegistro.VARIAVEL);
        ...
        // Caso seja a declaração de um novo registro.
            ...
            saida.append("struct{\n");
            for (AnalisadorSemanticoLAParser.VariavelContext vctx : ctx.tipo().registro().variavel()) {
                visitVariavel(vctx);
            }
            ...
            escopos.abandonarEscopo();
            escopoAtual.adicionar(ctx.identificador(0).getText(), TipoT5.REGISTRO, TipoRegistro.VARIAVEL);
        }
    ...
    public Void visitDeclaracao_global(AnalisadorSemanticoLAParser.Declaracao_globalContext ctx) {
        ...
        if (ctx.parametros() != null) {
            for (AnalisadorSemanticoLAParser.ParametroContext pctx : ctx.parametros().parametro()) {
                tipo = verificaTipoC(pctx.tipo_estendido().getText());
                nomeVariaveis = "";

                for (AnalisadorSemanticoLAParser.IdentificadorContext ictx : pctx.identificador()) {
                    nomeVariaveis += ictx.getText();
                    escopoParametros.adicionar(ictx.getText(), converteTipoT5(pctx.tipo_estendido().getText()), TipoRegistro.VARIAVEL);
                }
        ...
        if (ctx.tipo_estendido() != null)
            escopoAtual.adicionar(ctx.IDENT().getText(), converteTipoT5(ctx.tipo_estendido().getText()), TipoRegistro.FUNCAO);
        else
            escopoAtual.adicionar(ctx.IDENT().getText(), TipoT5.VOID, TipoRegistro.PROCEDIMENTO);

        // Executa os comandos.
        for (AnalisadorSemanticoLAParser.CmdContext cctx : ctx.cmd()) {
            visitCmd(cctx);
        }
    ...
    @Override
    public Void visitParcela_nao_unario(AnalisadorSemanticoLAParser.Parcela_nao_unarioContext ctx) {
    ...
    @Override
    public Void visitParcela_unario(AnalisadorSemanticoLAParser.Parcela_unarioContext ctx) {
    ...
    @Override
    public Void visitOp_relacional(AnalisadorSemanticoLAParser.Op_relacionalContext ctx) {
    ...
    @Override
    public Void visitCmdRetorne(AnalisadorSemanticoLAParser.CmdRetorneContext ctx) {
    ...
    @Override
    public Void visitExpressao(AnalisadorSemanticoLAParser.ExpressaoContext ctx) {
    ...
    @Override 
    public Void visitTermo_logico(AnalisadorSemanticoLAParser.Termo_logicoContext ctx){
        ...
        if (ctx.fator_logico().size() > 1) {
            ...
            for(AnalisadorSemanticoLAParser.Fator_logicoContext fatorLogico : ctx.fator_logico()) {
                saida.append(" && ");
    ...
    @Override
    public Void visitFator_logico(AnalisadorSemanticoLAParser.Fator_logicoContext ctx) {
    ...
    @Override
    public Void visitOp2(AnalisadorSemanticoLAParser.Op2Context ctx) {
    ...
    @Override
    public Void visitParcela_logica(AnalisadorSemanticoLAParser.Parcela_logicaContext ctx) {
    ...
    @Override
    public Void visitExp_relacional(AnalisadorSemanticoLAParser.Exp_relacionalContext ctx) {
    ...
    public Void visitCmdSe(AnalisadorSemanticoLAParser.CmdSeContext ctx) {
        ...
        for (AnalisadorSemanticoLAParser.CmdContext cctx : ctx.cmdEntao)
            super.visitCmd(cctx);
        ...
        if (ctx.getText().contains("senao")) {
            ...
            for (AnalisadorSemanticoLAParser.CmdContext cctx : ctx.cmdSenao)
                super.visitCmd(cctx);
    ...
    @Override
    public Void visitCmdPara(AnalisadorSemanticoLAParser.CmdParaContext ctx) {
    ...
    @Override
    public Void visitCmdFaca(AnalisadorSemanticoLAParser.CmdFacaContext ctx) {
    ...
    public Void visitCmdEscreva(AnalisadorSemanticoLAParser.CmdEscrevaContext ctx) {
        ...
        for (AnalisadorSemanticoLAParser.ExpressaoContext ectx : ctx.expressao()) {
    ...
    @Override
    public Void visitCmdCaso(AnalisadorSemanticoLAParser.CmdCasoContext ctx) {
        ...
        for (AnalisadorSemanticoLAParser.Item_selecaoContext sctx : ctx.selecao().item_selecao()) {
            ...
            for (AnalisadorSemanticoLAParser.CmdContext cctx : sctx.cmd())
                visitCmd(cctx);
    ...
    @Override
    public Void visitCmdChamada(AnalisadorSemanticoLAParser.CmdChamadaContext ctx) {
