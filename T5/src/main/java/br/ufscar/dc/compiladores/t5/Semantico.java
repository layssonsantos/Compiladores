...
import static br.ufscar.dc.compiladores.t5.SemanticoUtils.adicionaErroSemantico;
import static br.ufscar.dc.compiladores.t5.SemanticoUtils.confereTipo;
import static br.ufscar.dc.compiladores.t5.SemanticoUtils.verificaCompatibilidade;
...
public class Semantico extends AnalisadorSemanticoLABaseVisitor<Void> {
    ...
    static HashMap<String, ArrayList<TipoT5>> funcaoProcedimento = new HashMap<>();
    ...
    public void adicionaVariavelTabela(String nome, String tipo, Token nomeT, Token tipoT, TipoRegistro tipoRegistro) {
        ...
        // Mapeia string do tipo para enum TipoT5
        switch (tipo) {
            case "literal":
